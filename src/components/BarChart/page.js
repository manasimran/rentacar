  ...
  return (
    <Box sx={{ width: '100%' }}>
      <BarChart
        ...
        borderRadius={10}
        width={440}
        series={[{ data: [400, 300,,379,623,739,729,71,237,348, 500, 100, 200] }, { data: [100, 440, 622,700,736,736,124,874,352,462,236 ,300] }, { data: [230,60,170 ,500, 606,101,234,958,354,234,234,300]} ]}
      />
    </Box>
  );
}
